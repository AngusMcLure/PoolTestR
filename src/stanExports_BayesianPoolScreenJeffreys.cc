...
#include "stanExports_BayesianPoolScreenJeffreys.h"

RCPP_MODULE(stan_fit4BayesianPoolScreenJeffreys_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_BayesianPoolScreenJeffreys")
