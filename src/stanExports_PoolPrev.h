...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_PoolPrev");
    reader.add_event(36, 34, "end", "model_PoolPrev");
    return reader;
}
#include <stan_meta_header.hpp>
class model_PoolPrev
  : public stan::model::model_base_crtp<model_PoolPrev> {
private:
        int N;
...
typedef model_PoolPrev_namespace::model_PoolPrev stan_model;
#ifndef USING_R
