...
public:
  ...
  model_HierPoolPrevTotalSD(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_HierPoolPrevTotalSD_namespace::model_HierPoolPrevTotalSD";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      stan::math::validate_positive_index("var_frac", "L", L);
      current_statement__ = 56;
      stan::math::validate_non_negative_index("group_sd", "L", L);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
    num_params_r__ = 1 + TotalGroups + 1 + (L - 1);
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_HierPoolPrevTotalSD_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      local_scalar_t__ total_group_sd = DUMMY_VAR__;
      current_statement__ = 3;
      total_group_sd = in__.template read_constrain_lb<local_scalar_t__,
                         jacobian__>(0, lp__);
      Eigen::Matrix<local_scalar_t__,-1,1> var_frac =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(L, DUMMY_VAR__);
      current_statement__ = 4;
      var_frac = in__.template read_constrain_simplex<
                   Eigen::Matrix<local_scalar_t__,-1,1>, jacobian__>(lp__, L);
      Eigen::Matrix<local_scalar_t__,-1,1> group_sd =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(L, DUMMY_VAR__);
      current_statement__ = 6;
      stan::model::assign(group_sd,
        stan::math::multiply(stan::math::sqrt(var_frac), total_group_sd),
        "assigning variable group_sd");
      current_statement__ = 5;
      stan::math::check_greater_or_equal(function__, "group_sd", group_sd, 0);
      {
        ...
        lp_accum__.add(stan::math::student_t_lpdf<propto__>(total_group_sd,
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_HierPoolPrevTotalSD_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      local_scalar_t__ total_group_sd = DUMMY_VAR__;
      current_statement__ = 3;
      total_group_sd = in__.read<local_scalar_t__>();
      out__.write_free_lb(0, total_group_sd);
      Eigen::Matrix<local_scalar_t__,-1,1> var_frac =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(L, DUMMY_VAR__);
      current_statement__ = 4;
      stan::model::assign(var_frac,
        in__.read<Eigen::Matrix<local_scalar_t__,-1,1>>(L),
        "assigning variable var_frac");
      out__.write_free_simplex(var_frac);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  }
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      ...
      current_statement__ = 3;
      context__.validate_dims("parameter initialization", "total_group_sd",
        "double", std::vector<size_t>{});
      current_statement__ = 4;
      context__.validate_dims("parameter initialization", "var_frac",
        ...
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(L, DUMMY_VAR__);
      {
        ...
        current_statement__ = 4;
        var_frac_flat__ = context__.vals_r("var_frac");
        current_statement__ = 4;
        pos__ = 1;
        current_statement__ = 4;
        for (int sym1__ = 1; sym1__ <= L; ++sym1__) {
          current_statement__ = 4;
          stan::model::assign(var_frac, var_frac_flat__[(pos__ - 1)],
            "assigning variable var_frac", stan::model::index_uni(sym1__));
          current_statement__ = 4;
          pos__ = (pos__ + 1);
        }
      }
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"Intercept", "u", "total_group_sd",
                "var_frac"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"group_sd"};
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    for (int sym1__ = 1; sym1__ <= L; ++sym1__) {
      param_names__.emplace_back(std::string() + "var_frac" + '.' +
        std::to_string(sym1__));
    }
    if (emit_transformed_parameters__) {
      for (int sym1__ = 1; sym1__ <= L; ++sym1__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"Intercept\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"u\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(TotalGroups) + "},\"block\":\"parameters\"},{\"name\":\"total_group_sd\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"var_frac\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(L) + "},\"block\":\"parameters\"},{\"name\":\"group_sd\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(L) + "},\"block\":\"transformed_parameters\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"Intercept\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"u\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(TotalGroups) + "},\"block\":\"parameters\"},{\"name\":\"total_group_sd\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"var_frac\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((L -1)) + "},\"block\":\"parameters\"},{\"name\":\"group_sd\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(L) + "},\"block\":\"transformed_parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((1 + TotalGroups) + 1) + L);
