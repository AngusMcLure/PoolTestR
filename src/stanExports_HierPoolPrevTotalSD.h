...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HierPoolPrevTotalSD");
    reader.add_event(70, 68, "end", "model_HierPoolPrevTotalSD");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HierPoolPrevTotalSD
  : public stan::model::model_base_crtp<model_HierPoolPrevTotalSD> {
private:
        int N;
        int L;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "InterceptNu", "double", context__.to_vec());
            InterceptNu = double(0);
            vals_r__ = context__.vals_r("InterceptNu");
            pos__ = 0;
            InterceptNu = vals_r__[pos__++];
            check_greater_or_equal(function__, "InterceptNu", InterceptNu, 0);
            current_statement_begin__ = 12;
            context__.validate_dims("data initialization", "InterceptMu", "double", context__.to_vec());
            InterceptMu = double(0);
            vals_r__ = context__.vals_r("InterceptMu");
            pos__ = 0;
            InterceptMu = vals_r__[pos__++];
            check_greater_or_equal(function__, "InterceptMu", InterceptMu, 0);
            current_statement_begin__ = 13;
            context__.validate_dims("data initialization", "InterceptSigma", "double", context__.to_vec());
            InterceptSigma = double(0);
            vals_r__ = context__.vals_r("InterceptSigma");
            pos__ = 0;
            InterceptSigma = vals_r__[pos__++];
            check_greater_or_equal(function__, "InterceptSigma", InterceptSigma, 0);
            current_statement_begin__ = 15;
            context__.validate_dims("data initialization", "GroupSDNu", "double", context__.to_vec());
            GroupSDNu = double(0);
            vals_r__ = context__.vals_r("GroupSDNu");
            pos__ = 0;
            GroupSDNu = vals_r__[pos__++];
            check_greater_or_equal(function__, "GroupSDNu", GroupSDNu, 0);
            current_statement_begin__ = 16;
            context__.validate_dims("data initialization", "GroupSDMu", "double", context__.to_vec());
            GroupSDMu = double(0);
            vals_r__ = context__.vals_r("GroupSDMu");
            pos__ = 0;
            GroupSDMu = vals_r__[pos__++];
            check_greater_or_equal(function__, "GroupSDMu", GroupSDMu, 0);
            current_statement_begin__ = 17;
            context__.validate_dims("data initialization", "GroupSDSigma", "double", context__.to_vec());
            GroupSDSigma = double(0);
            vals_r__ = context__.vals_r("GroupSDSigma");
            pos__ = 0;
            GroupSDSigma = vals_r__[pos__++];
            ...
            validate_non_negative_index("var_frac", "L", L);
            num_params_r__ += (L - 1);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 37;
        if (!(context__.contains_r("total_group_sd")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable total_group_sd missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("total_group_sd");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "total_group_sd", "double", context__.to_vec());
        double total_group_sd(0);
        total_group_sd = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, total_group_sd);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable total_group_sd: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 38;
        if (!(context__.contains_r("var_frac")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable var_frac missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("var_frac");
        pos__ = 0U;
        validate_non_negative_index("var_frac", "L", L);
        context__.validate_dims("parameter initialization", "var_frac", "vector_d", context__.to_vec(L));
        Eigen::Matrix<double, Eigen::Dynamic, 1> var_frac(L);
        size_t var_frac_j_1_max__ = L;
        for (size_t j_1__ = 0; j_1__ < var_frac_j_1_max__; ++j_1__) {
            var_frac(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.simplex_unconstrain(var_frac);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable var_frac: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            (void) total_group_sd;  // dummy to suppress unused var warning
            if (jacobian__)
                total_group_sd = in__.scalar_lb_constrain(0, lp__);
            else
                total_group_sd = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 38;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> var_frac;
            (void) var_frac;  // dummy to suppress unused var warning
            if (jacobian__)
                var_frac = in__.simplex_constrain(L, lp__);
            else
                var_frac = in__.simplex_constrain(L);
            // transformed parameters
            current_statement_begin__ = 41;
            validate_non_negative_index("group_sd", "L", L);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> group_sd(L);
            stan::math::initialize(group_sd, DUMMY_VAR__);
            stan::math::fill(group_sd, DUMMY_VAR__);
            // transformed parameters block statements
            current_statement_begin__ = 42;
            stan::math::assign(group_sd, multiply(stan::math::sqrt(var_frac), total_group_sd));
            ...
            for (size_t j_1__ = 0; j_1__ < group_sd_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(group_sd(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: group_sd" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable group_sd: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            check_greater_or_equal(function__, "group_sd", group_sd, 0);
            // model body
            {
            ...
            stan::math::assign(ps, stan::math::exp(elt_multiply(log1m_inv_logit(add(Intercept, csr_matrix_times_vector(N, TotalGroups, Zw, Zv, Zu, au))), PoolSize)));
            current_statement_begin__ = 64;
            lp_accum__.add(student_t_log<propto__>(Intercept, InterceptNu, InterceptMu, InterceptSigma));
            current_statement_begin__ = 65;
            lp_accum__.add(student_t_log<propto__>(total_group_sd, GroupSDNu, GroupSDMu, GroupSDSigma));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("u");
        names__.push_back("total_group_sd");
        names__.push_back("var_frac");
    ...
    void write_array(RNG& base_rng__,
        ...
        double total_group_sd = in__.scalar_lb_constrain(0);
        vars__.push_back(total_group_sd);
        Eigen::Matrix<double, Eigen::Dynamic, 1> var_frac = in__.simplex_constrain(L);
        size_t var_frac_j_1_max__ = L;
        for (size_t j_1__ = 0; j_1__ < var_frac_j_1_max__; ++j_1__) {
            vars__.push_back(var_frac(j_1__));
        }
        double lp__ = 0.0;
    ...
    std::string model_name() const {
        return "model_HierPoolPrevTotalSD";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_name_stream__.str(std::string());
        param_name_stream__ << "total_group_sd";
        param_names__.push_back(param_name_stream__.str());
        size_t var_frac_j_1_max__ = L;
        for (size_t j_1__ = 0; j_1__ < var_frac_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "var_frac" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        if (!include_gqs__ && !include_tparams__) return;
        if (include_tparams__) {
...
typedef model_HierPoolPrevTotalSD_namespace::model_HierPoolPrevTotalSD stan_model;
#ifndef USING_R
