...
#include "stanExports_BayesianPoolScreenGeneralised.h"

RCPP_MODULE(stan_fit4BayesianPoolScreenGeneralised_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_BayesianPoolScreenGeneralised")
