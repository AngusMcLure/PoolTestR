...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HierPoolPrevIndividualSD");
    reader.add_event(69, 67, "end", "model_HierPoolPrevIndividualSD");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HierPoolPrevIndividualSD
  : public stan::model::model_base_crtp<model_HierPoolPrevIndividualSD> {
private:
        int N;
        int L;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(student_t_log<propto__>(group_sd, GroupSDNu, GroupSDMu, GroupSDSigma));
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            stan::math::initialize(total_group_sd, DUMMY_VAR__);
            stan::math::fill(total_group_sd, DUMMY_VAR__);
            // generated quantities statements
            current_statement_begin__ = 66;
            stan::math::assign(total_group_sd, stan::math::sqrt(dot_self(group_sd)));
...
typedef model_HierPoolPrevIndividualSD_namespace::model_HierPoolPrevIndividualSD stan_model;
#ifndef USING_R
