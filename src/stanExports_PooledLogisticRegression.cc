...
#include "stanExports_PooledLogisticRegression.h"

RCPP_MODULE(stan_fit4PooledLogisticRegression_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_PooledLogisticRegression")
