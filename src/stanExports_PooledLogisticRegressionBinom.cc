...
#include "stanExports_PooledLogisticRegressionBinom.h"

RCPP_MODULE(stan_fit4PooledLogisticRegressionBinom_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_PooledLogisticRegressionBinom")
