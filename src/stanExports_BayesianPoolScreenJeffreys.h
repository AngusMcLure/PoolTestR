...
namespace model_BayesianPoolScreenJeffreys_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BayesianPoolScreenJeffreys");
    reader.add_event(26, 24, "end", "model_BayesianPoolScreenJeffreys");
    return reader;
}
#include <stan_meta_header.hpp>
class model_BayesianPoolScreenJeffreys
  : public stan::model::model_base_crtp<model_BayesianPoolScreenJeffreys> {
private:
        int N;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_BayesianPoolScreenJeffreys_namespace::model_BayesianPoolScreenJeffreys";
    ...
    ~model_BayesianPoolScreenJeffreys() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(stan::math::log(s));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_BayesianPoolScreenJeffreys_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_BayesianPoolScreenJeffreys";
    }
...
typedef model_BayesianPoolScreenJeffreys_namespace::model_BayesianPoolScreenJeffreys stan_model;
#ifndef USING_R
