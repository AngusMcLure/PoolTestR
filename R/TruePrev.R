...
#'
#'
#' This \code{data.frame} contains the 'true' values of prevalence for each, site,
...
#'   e.g. "B-3" is village 3 from region B}
#'   \item{Site}{ID of sampling site pool was
#'   taken from. Includes name of region and village e.g. "B-3-7" is site 7 from
#'   village 3 from region B}
#'   \item{Year}{Year of sampling. Years are 0, 1, or 2}
#'   \item{PrevalenceRegion}{'True' average prevalence in the region (in that
#'   year)}
#'   \item{PrevalenceVillage}{'True' average prevalence in the village
#'   (in that year)}
#'   \item{PrevalenceSite}{'True' prevalence at that site (in
#'   that year)} }
"TruePrev"
