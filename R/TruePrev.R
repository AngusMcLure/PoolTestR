...
#'
#'
#' This dataframe contains the 'true' values of prevalence for each, site, village, region and year used to generate the synthetic dataset \code{ExampleData}
#'
...
#'   \item{PrevalenceRegion}{'True' average prevalence in the region (in that year)}
#'   \item{PrevalenceVillage}{'True' average prevalence in the village (in that year)}
#'   \item{PrevalenceSite}{'True' prevalence at that site (in that year)}
#'   }
"TruePrev"
